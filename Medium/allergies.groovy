...
println "You're allergens are: $allergens"

if(allergic in allergens) println "You are allergic to: $allergic"
else println "You are not allergic to: $allergic"
