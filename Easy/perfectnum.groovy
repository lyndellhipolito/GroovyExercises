...
def num = System.in.newReader().readLine() as Integer
int total = 0
...
if(num == total)        println "$num is a perfect number"
else if(num < total)    println "$num is an abundant number"
else if(num > total)    println "$num is a deficient number"
else                    println "Please enter a number."